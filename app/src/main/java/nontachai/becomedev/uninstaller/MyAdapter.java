...
import nontachai.becomedev.uninstaller.AppInfo;
import nontachai.becomedev.uninstaller.MainActivity;
import nontachai.becomedev.uninstaller.R;

import static nontachai.becomedev.uninstaller.MainActivity.packageDeleted;
        ...
        holder.checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    ...
                    MainActivity.allPackagesSelected.add(tabiqati.getPackageName());
                    ...
                    MainActivity.allPackagesSelected.remove(tabiqati.getPackageName());
                    MainActivity.appCounter--;
                    MainActivity.setTextForUninstallerCounterApp(MainActivity.appCounter);
